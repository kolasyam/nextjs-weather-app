...
export default function Home() {
  ...
  const { isLoading, error, data ,refetch} = useQuery<WeatherData>('repoData', async () =>
    {
      const {data}=await axios.get(`https://api.openweathermap.org/data/2.5/forecast?q=${place}&appid=0f25db4edbd306fff3e6a2036655fe27&cnt=56`
    );
      return data;
    }
  );
    ...
    {loadingCity? (<WeatherSkeleton/>):(
        ...
        <section className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <Container className="bg-yellow-300/80 px-6 gap-4 justify-between mx-auto sm:gap-16 overflow-x-auto">
